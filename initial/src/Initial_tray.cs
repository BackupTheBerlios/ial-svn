/***************************************************************************
 *
 * Initial_tray.cs - Tray-Icon Support
 *
 * SVN ID: $Id$
 *
 * Copyright (C) 2005 The Mono Project
 *               2005 Timo Hoenig <thoenig@nouse.net>
 *
...
namespace Initial
{
    public class TrayIcon : Plug
    {
        ...
        extern static int XSendEvent(IntPtr display, IntPtr window, bool propagate, EventMask event_mask,
